...
public abstract class ImageWorker {
    ...
    protected ImageWorker(Context context, ImageCache cache){
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
        ...
        private final DisplayOptions           mOptions;

        public BitmapWorkerTask(Object data, ImageView imageView, DisplayOptions options ){
            mData = data;
        ...
        protected BitmapDrawable doInBackground(Void... params) {
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
                bitmap = processBitmap(mData, getAttachedImageView());
            }
            ...
            if (bitmap != null) {
                ...
                if (mImageCache != null) {
                    mImageCache.addBitmapToCache(dataString, drawable, mOptions);
                }
            }
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            if (value != null && imageView != null) {
                ...
                setImageDrawable(imageView, value, mOptions);
            }
          //  mListener.onLoadingComplete(mData, imageView, value);
