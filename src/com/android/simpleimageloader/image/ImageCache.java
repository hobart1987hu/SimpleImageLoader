...
import com.android.simpleimageloader.BuildConfig;
import com.android.simpleimageloader.drawable.RecyclingBitmapDrawable;
import com.android.simpleimageloader.image.ImageCache.ImageCacheParams;
import com.android.simpleimageloader.util.ImageUtils;
import com.android.simpleimageloader.util.Utils;

/**
 * This class handles disk and memory caching of bitmaps in conjunction with the {@link ImageWorker} class and its
 * subclasses. Use {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to get an
 * instance of this class, although usually a cache should be added directly to an {@link ImageWorker} by calling
...
public class ImageCache {
     ...
     * classes, instead use {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            bitmap = ImageUtils.decodeSampledBitmapFromDescriptor(fd, Integer.MAX_VALUE,
