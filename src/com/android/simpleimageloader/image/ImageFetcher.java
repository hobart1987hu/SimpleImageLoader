...
import com.android.simpleimageloader.R;
...
public class ImageFetcher extends ImageWorker {
    ...
    public ImageFetcher(Context context,ImageCache imageCache){
    ...
    private Bitmap processBitmap(String data, ImageView imageView) {
        ...
        if (fileDescriptor != null) {
            bitmap = ImageUtils.decodeSampledBitmapFromDescriptor(fileDescriptor, imageView.getWidth(),
                                                                  imageView.getHeight(), getImageCache());
        }
